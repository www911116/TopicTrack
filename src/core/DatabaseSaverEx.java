...
public class DatabaseSaverEx 
  ...
  static {
    ...
    */
  public DatabaseSaverEx() throws Exception{
  ...
  public void writeInstances(Instances inst) throws Exception{
	  for(int i=0;i<inst.numInstances();i++){
		  writeInstance(inst.instance(i));
	  }
  }
