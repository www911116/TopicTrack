...
public class DBScan 
     ...
     */
    private String database_distanceType = "core.EuclidianDataObject";
    ...
    public void buildClusterer(Instances instances) throws Exception {
    	...
    	for(int i=0;i<arr.length;i++){
			...
			if(t.getClusterLabel() == DataObject.NOISE) attsarr[0]=-1;
			else attsarr[0] = t.getClusterLabel();
    ...
    /**
     *Returns a list of central points of each cluster 
     * */
